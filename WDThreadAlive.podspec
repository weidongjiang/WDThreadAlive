...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/weidongjiang/WDThreadAlive'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'weidongjiang' => 'weidong17@satff.weibo.com' }
  s.source           = { :git => 'https://github.com/weidongjiang/WDThreadAlive.git', :tag => s.version.to_s }
